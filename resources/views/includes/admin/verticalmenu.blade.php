                            ...
                            <ul class="side-menu custom-ul">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label">স্থান</span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        
                                      
                                        <li><a href="{{url('/admin/alltickets')}}" class="slide-item">জেলা</a></li>
                                      
                                        
                                       
                                        <li><a href="{{url('/admin/alltickets')}}" class="slide-item">উপজেলা</a></li>
                                       
                                        
                                        <li><a href="{{url('/admin/myticket')}}" class="slide-item">ফারি</a></li>
